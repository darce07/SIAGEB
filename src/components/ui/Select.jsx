export default function Select({
  ...
  const labelClass = compact
    ...
    : 'flex flex-col gap-2 text-[14px] leading-[1.55] text-slate-200';
  const labelTextClass = compact
    ? 'text-[10px] uppercase tracking-[0.12em] text-slate-400'
    : 'text-[11px] uppercase tracking-[0.14em] text-slate-400';
  const selectClass = compact
    ...
    : 'h-10 w-full rounded-xl border border-slate-700/60 bg-slate-900/70 px-3 text-[14px] leading-[1.55] text-slate-100 focus:border-cyan-400 focus:outline-none focus:ring-2 focus:ring-cyan-500/30';
